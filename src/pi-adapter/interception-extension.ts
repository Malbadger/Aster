 ...
 * genuine pre-execution gate — LAW's policy decides, Pi enforces the block.
 *
...
/**
 * Create an inline Pi extension that applies a LAW ToolInterceptor to every tool call.
