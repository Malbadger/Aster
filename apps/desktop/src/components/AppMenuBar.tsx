...
export function AppMenuBar(props: AppMenuBarProps): React.JSX.Element {
  return <nav className="menubar" aria-label="Application menu">
    ...
    <Menu label="Terminal"><Item shortcut="Ctrl+`" onClick={() => props.onTogglePanel("terminal")}>New Terminal</Item><Item onClick={() => props.onTogglePanel("terminal")}>Show Terminal Panel</Item><Item onClick={props.onOpenTerminal}>Open External Terminal</Item><Item disabled>Split Terminal</Item><Item disabled>Clear Terminal</Item><Item disabled>Kill Active Terminal</Item></Menu>
